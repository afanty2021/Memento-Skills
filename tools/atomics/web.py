...
async def search_web(
    ...
    def _run() -> str:
        try:
            ...
            return f"ERR: search_web failed: {e}"

    return await asyncio.to_thread(_run)


fetch_webpage._schema = _FETCH_SCHEMA  # type: ignore[attr-defined]
search_web._schema = _SEARCH_SCHEMA  # type: ignore[attr-defined]
